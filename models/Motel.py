...
class Motel(Hotel):
    ...
    def __init__(self, name, total_rooms, available_rooms, rating, number_of_track, kilometer_of_track, start_city, end_city, name_of_track):
        """
    ...
    Number Of Track: {self.number_of_track}, Kilometer Of Track: {self.kilometer_of_track},
    Start City: {self.start_city}, End City: {self.end_city}, Name Of Track: {self.name_of_track}"""     
        
    def __repr__(self):
      return f"Motel='{self.name}', total_rooms={self.total_rooms}, available_rooms={self.available_rooms}, rating={self.rating}, number_of_track={self.number_of_track}, kilometer_of_track={self.kilometer_of_track}, start_city='{self.start_city}', end_city='{self.end_city}', name_of_track='{self.name_of_track}'"
    ...
    def get_location(self):
       ...
       """
       return self.get_name_of_track() + self.get_kilometer_of_track()
