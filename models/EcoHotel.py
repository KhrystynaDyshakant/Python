...
class EcoHotel(Hotel):
    ...
    """
    def __init__(self, name, total_rooms, available_rooms, rating, gym, garden):
        """
    ...
    def __repr__(self):
      return f"EcoHotel:'{self.name}', total_rooms={self.total_rooms}, available_rooms={self.available_roooms}, rating={self.rating}, gym={self.gym}, garden={self.garden}"
